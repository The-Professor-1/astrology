...
from .views import calculate,wealth_view,calculators_list,life_luck,behavior_view,place_view,marriage_luck_view,military_prophecy,love_prophecy,legal_prophecy,marriage_length_prophecy,enemy_behavior,patient_prophecy,pregnancy_prophecy,birth_prophecy,servant_behavior
